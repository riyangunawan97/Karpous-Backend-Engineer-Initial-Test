...
from .views import ListUserInvestmentsView, CreateInvestmentView, InvestmentSummaryView, InvestmentSummaryView
...
urlpatterns = [
    ...
    path('', ListUserInvestmentsView.as_view(), name='list-investments'),
